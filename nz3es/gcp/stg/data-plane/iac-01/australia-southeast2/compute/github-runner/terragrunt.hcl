...
locals {
  ...
  # GitHub App config — fill in after creating the GitHub App
  github_user                = "elayaraja-kv"
  github_repo                = "infra-as-code"
  github_app_id              = "3030666"
  github_app_installation_id = "114630061"
  ...
  startup_script = <<-SCRIPT
    ...
    RUNNER_LABELS="self-hosted,linux,x64,stg,vm"
